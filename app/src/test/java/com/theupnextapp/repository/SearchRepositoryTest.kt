...
class SearchRepositoryTest {
    ...
    @Test
    fun `getShowSearchResults with valid query returns success`() =
        runTest {
    ...
    @Test
    fun `getShowSearchResults with null query returns empty list`() =
        runTest {
    ...
    @Test
    fun `getShowSearchResults with empty query returns empty list`() =
        runTest {
    ...
    @Test
    fun `getShowSearchResults handles network failure gracefully`() =
        runTest {
